    ...
    public static void main(String[] args) {
        ...
        try(Connection conn = DBConnection.getConnection())
        {
            if (input.nextInt() == 1) {
                ...
                boolean success = userDAO.add(conn, user);
                ...
                User user2 = new UserDAO().getDetails(conn, 2);
...
//            useredit.setBio("Hello! I'm Nour.");
                ...
                boolean success = new UserDAO().update(conn, useredit, 12);
                ...
                boolean success = new UserDAO().delete(conn, 12);
